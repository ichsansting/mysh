function terraform-version-name --description 'Resolve exact Terraform version from .terraform-version (supports latest, latest:<regex>)'
...
# Internal helper for terraform-version-name; bundled here (not its own autoload file)
